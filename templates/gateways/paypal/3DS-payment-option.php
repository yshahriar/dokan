<div class="card_container">
    <div class="form-row address-field validate-postcode form-row-wide">
        <label for="dpm_card_number" class=""><?php esc_html_e('Card Number', 'dokan-lite'); ?></label>
        <div id="dpm_card_number" class="card_field form-group"></div>
    </div>

    <div class="form-row address-field validate-postcode form-row-wide">
        <label for="dpm_card_expiry" class=""><?php esc_html_e('Expiration Date', 'dokan-lite'); ?></label>
        <div id="dpm_card_expiry" class="card_field form-group"></div>
    </div>

    <div class="form-row address-field validate-postcode form-row-wide">
        <label for="dpm_cvv" class=""><?php esc_html_e('CVV', 'dokan-lite'); ?></label>
        <div id="dpm_cvv" class="card_field form-group"></div>
    </div>

    <p class="form-row address-field validate-postcode form-row-wide">
        <label for="dpm_name_on_card" class=""><?php esc_html_e('Name on Card', 'dokan-lite'); ?></label>
